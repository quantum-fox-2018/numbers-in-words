...
function numberToWords(number) {
  ...
  for(let i = 0; i < digit.length; i++) {
    if(number.length >= digit[i]) {
      ...
      var terbilangTampung = ratusan(parseInt(number.slice(0, potong)));
      if(terbilangTampung) {
  ...
  arrAngka.push(ratusan(parseInt(number)));
...
function ratusan(number) {
  ...
  if(number >= 100) {
    ...
    var angkaDepan = (number - tampung) / 100;
    if(angkaDepan === 1) {
      return "seratus " + ratusan(number-100);
    } else {
      var index = angka2.indexOf(angkaDepan);
      number -= angkaDepan*100;
      return angka1[index] + " ratus " + ratusan(number);
    }
  }
  ...
  if(number >= 10) {
    if(number < 20) {
      ...
      var index = angka2.indexOf(angkaDepan);
      number -= angkaDepan*10;
      return angka1[index] + " puluh " + ratusan(number);
    }
  }
}
...
function numberToWords(number) {
  ...
  if(number.length >= 13) {
    ...
    var terbilangTampung = ratusan(parseInt(number.slice(0, potong))) + " triliun ";
    number = number.slice(potong);
    ...
    var terbilangTampung = ratusan(parseInt(number.slice(0, potong))) + " milyar ";
    number = number.slice(potong);
    return terbilangTampung + numberToWords(parseInt(number));
    ...
    var terbilangTampung = ratusan(parseInt(number.slice(0, potong))) + " juta ";
    number = number.slice(potong);
    return terbilangTampung + numberToWords(parseInt(number));
    ...
    var terbilangTampung = ratusan(parseInt(number.slice(0, potong))) + " ribu ";
    number = number.slice(potong);
    return terbilangTampung + numberToWords(parseInt(number));
  } else {
    var terbilangTampung = ratusan(parseInt(number.slice(0, potong)));
